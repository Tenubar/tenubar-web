...
## Overview
**Compulsiva Store** features a MongoDB database, a registration system, and a database to store images, users, purchases, products, drafts, comments, and other user details. It was created to allow administrators to create, edit, or delete products as quickly and easily as possible. It features a single administrator tool (usable only for the administrator email) in the header, making page management easier. It is also available in English and Spanish. If the page takes too long to fetch the database information is due the free hosting service. Please wait 50 seconds. 
